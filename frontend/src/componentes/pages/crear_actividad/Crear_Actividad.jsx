        ...
        <Caja_formularios
          info={
            <div className="create-activity-admin-box">
              <h2 className="text-center crear-actividades-titulo">
                Crear Actividad
              </h2>
              <form
              ...
              >
                <label
                  ...
                  className="form-create-activity-apr-content__col1__label"
                >
                ...
                <input
                  type="text"
                  id="nombre-actividad"
                  className="form-create-activity-apr-content__col1__input"
