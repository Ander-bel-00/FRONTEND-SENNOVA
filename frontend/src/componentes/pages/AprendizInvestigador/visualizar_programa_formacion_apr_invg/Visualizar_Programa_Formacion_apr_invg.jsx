          ...
          <table className="list-visualize-table-admin">
            <thead>
              <tr className="list-visualize-table__tr-admin">
                ...
                <th className="list-visualize-table__th-admin">
                  Número de Ficha
                </th>
                <th className="list-visualize-table__th-admin">
                  Inicio Lectiva
            ...
            <tbody>
              {programasFormacion.length > 0 ? (
                programasFormacion.map((programa) => (
                  <tr
                    className="list-visualize-table__tr-admin"
                    key={programa.id}
                  >
                    <td className="list-visualize-table__td-admin">
                      {" "}
                      {programa.codigo_programa_formacion}{" "}
                    </td>
                    <td className="list-visualize-table__td-admin">
                      {" "}
                      {programa.version_programa_formacion}{" "}
                    </td>
                    <td className="list-visualize-table__td-admin">
                      {" "}
                    ...
                    <td className="list-visualize-table__td-admin">
                      {" "}
                      {programa.inicio_lectiva}{" "}
                    </td>
                    <td className="list-visualize-table__td-admin">
                      {" "}
                      {programa.fin_lectiva}{" "}
                    </td>
                  </tr>
                ))
              ) : (
