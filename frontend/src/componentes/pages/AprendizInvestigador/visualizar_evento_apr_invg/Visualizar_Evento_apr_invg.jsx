      ...
      Header_Tools={
        <Fragment>  
          <div className="btn-vs-evento-instructor">
            <BotonReturn link={"/aprendiz-investigador/Listar-eventos"} icon={<IoIosReturnLeft/>}/>
         </div>
        ...
        <table className="vis-event-table-instructor">
          <thead>
                <tr className="vis-event-table-aprendiz__tr">
                  ...
                  <th className="vis-event-table-aprendiz__th">Fecha de Inicio</th>
                  <th className="vis-event-table-aprendiz__th">Fecha de Fin</th>
                  <th className="vis-event-table-aprendiz__th">Cantidad de Participantes</th>
              ...
              <tbody>
                ...
                <tr className="vis-event-table-aprendiz__tr" key={index}>
                  <td className="vis-event-table-aprendiz__td"> {Contenido.nombre}</td>
                  <td className="vis-event-table-aprendiz__td"> {Contenido.fecha_inicio} </td>
                  <td className="vis-event-table-aprendiz__td"> {Contenido.fecha_fin} </td>
                  <td className="vis-event-table-aprendiz__td"> {Contenido.cantidad} </td>
                  <td className="vis-event-table-aprendiz__td"> {Contenido.lugar} </td>
                  <td className="vis-event-table-aprendiz__td"> {Contenido.tipo} </td>
